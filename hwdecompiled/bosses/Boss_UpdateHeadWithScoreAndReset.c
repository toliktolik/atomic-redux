/*
 * Function: Boss_UpdateHeadWithScoreAndReset
 * Address: 00435a20
 * Category: bosses
...
void __fastcall Boss_UpdateHeadWithScoreAndReset(int param_1)

{
  ...
  Game_DisplayScoreChange
            (*(void **)(param_1 + 0x4c),*(int *)(*(int *)(param_1 + 0x50) + 0xda4),(int)uVar2,iVar1)
  ;
