/*
 * Function: Boss_ProcessBattleshipAttack
 * Address: 00405c80
 * Category: bosses
...
void __thiscall
Boss_ProcessBattleshipAttack(void *this,undefined4 *param_1,undefined4 *param_2,undefined4 *param_3)

{
  ...
  if (param_2 != (undefined4 *)0x0) {
    ...
    if (uVar2 < (uint)(iVar7 + (int)param_2)) {
      ...
      local_8 = 0;
      puVar5 = (undefined4 *)ArrayInit_36ByteObjects(*(undefined4 **)((int)this + 4),param_1,puVar4)
      ;
      ArrayInit_4ByteObjects(puVar5,(int)param_2,&param_3);
      ArrayInit_36ByteObjects(param_1,*(undefined4 **)((int)this + 8),puVar5 + (int)param_2);
      iVar3 = *(int *)((int)this + 4);
      if (iVar3 == 0) {
        iVar7 = 0;
      }
    ...
    if ((undefined4 *)((int)puVar5 - (int)param_1 >> 2) < param_2) {
      iVar3 = (int)param_2 * 4;
      ExceptionList = &local_10;
      PowerUp_ProcessPickup(param_1,puVar5,param_1 + (int)param_2);
      local_8 = 2;
      ...
      *(int *)((int)this + 8) = iVar3;
      ...
      ExceptionList = &local_10;
      uVar6 = PowerUp_ProcessPickup(param_2,puVar5,puVar5);
      puVar1 = param_2;
      *(undefined4 *)((int)this + 8) = uVar6;
      param_2 = (undefined4 *)&stack0xffffffcc;
      MemoryCopy_Backward_4ByteObjects(&param_2,(int)param_1,(int)puVar1,puVar5);
