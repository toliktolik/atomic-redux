...
int __thiscall Music_CrossFade(void *this,void *param_1)

{
  ...
  Database_ReconnectIfNeeded((void *)((int)this + 4),&param_1,param_1);
  if (param_1 != *(void **)((int)this + 8)) {
    iVar2 = *(int *)(*(int *)((int)param_1 + 0x28) + 0x4c);
    if (iVar2 == 0) {
      if ((*(char *)((int)this + 0xb4) == '\0') ||
         (*(char *)(*(int *)((int)param_1 + 0x28) + 0x48) == '\0')) goto LAB_004a0f76;
      iVar2 = 0;
    }
    ExceptionList = local_10;
    return iVar2;
...
LAB_004a0f76:
  uVar4 = Sound_SetPosition(local_2c,"Image resource not found: %s");
  local_8 = 0;
