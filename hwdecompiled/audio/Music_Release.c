...
void __thiscall
Music_Release(void *this,undefined4 *param_1,char param_2,undefined4 *param_3,_String_base *param_4)

{
  ...
  piVar5 = Image_AdjustContrast
                     (*(undefined4 *)((int)this + 4),param_3,*(undefined4 *)((int)this + 4),param_4,
                      0);
...
LAB_004a1435:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x28) = 0;
        piVar8 = *(int **)(*piVar6 + 4);
      }
      else {
        if (piVar8 == (int *)piVar2[2]) {
          Vector_Scale(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x28) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x28) = 0;
        Vector_Lerp(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[10] == '\0') goto LAB_004a1435;
      if (piVar8 == (int *)*piVar2) {
        Vector_Lerp(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x28) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x28) = 0;
      Vector_Scale(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x28);
  } while( true );
}
