...
int __thiscall Music_GetPosition(void *this,void *param_1)
  ...
  if (param_1 != *(void **)((int)this + 0x20)) {
    ...
    if (iVar2 == 0) {
      if ((*(char *)((int)this + 0xb4) == '\0') ||
         (*(char *)(*(int *)((int)param_1 + 0x28) + 0x48) == '\0')) goto LAB_004a11a6;
      iVar2 = 0;
    }
    ExceptionList = local_10;
    return iVar2;
...
LAB_004a11a6:
  uVar4 = Sound_SetPosition(local_2c,"Font resource not found: %s");
  local_8 = 0;
