...
void __thiscall
STL_Iterator_Begin(void *this,undefined4 *param_1,char param_2,undefined4 *param_3,
...

{
  ...
  piVar5 = (int *)STL_String_GetCapacity
...
LAB_00458265:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x38) = 0;
        piVar8 = *(int **)(*piVar6 + 4);
      }
      else {
        if (piVar8 == (int *)piVar2[2]) {
          XML_LoadDocument(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x38) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x38) = 0;
        XML_ValidateDocument(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[0xe] == '\0') goto LAB_00458265;
      if (piVar8 == (int *)*piVar2) {
        XML_ValidateDocument(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x38) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x38) = 0;
      XML_LoadDocument(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x38);
  } while( true );
}
