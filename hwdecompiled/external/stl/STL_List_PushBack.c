...

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  iVar3 = STL_List_PopFront((undefined1 *)(unaff_EBP + -0x54),(undefined4 *)(unaff_EBP + 0xc),
                            (int *)(unaff_EBP + 0x14));
  fVar6 = CRuntime_StringToFloat((char *)(unaff_EBP + -0x54),(char **)(unaff_EBP + -0x14),iVar3);
  *(float *)(unaff_EBP + -0x18) = (float)fVar6;
  *(undefined4 *)(unaff_EBP + -4) = 0xffffffff;
  ...
  if (*(int *)(unaff_EBP + -0x14) != unaff_EBP + -0x54) {
...
LAB_004f27c1:
  ...
  *puVar2 = *(undefined4 *)(unaff_EBP + 0xc);
  ...
  Exception_SetMessage
            ((void *)(*(uint *)(unaff_EBP + -0x10) ^ *(uint *)(unaff_EBP + 4)),in_stack_ffffffb8,
             in_stack_ffffffbc);
  return;
}
