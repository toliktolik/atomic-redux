/*
 * Function: STL_String_GetMaxSize
 * Address: 004573d0
 * Category: misc
...
void __thiscall STL_String_GetMaxSize(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if (param_2 != param_3) {
    do {
      ...
      STL_Map_EraseWithRebalance(&param_2,piVar5);
      piVar5 = piVar6;
    } while (piVar6 != piVar3);
  }
  *param_1 = piVar6;
