/*
 * Function: STL_DoubleMap_FindOrInsert
 * Address: 004ac230
 * Category: misc
...
void __thiscall STL_DoubleMap_FindOrInsert(void *this,undefined4 *param_1,_String_base *param_2)

{
  ...
  local_8 = true;
  if ((*(_String_base **)(p_Var8 + 4))[0xd1] == (_String_base)0x0) {
...
LAB_004ac2aa:
    ...
    } while (p_Var2[0xd1] == (_String_base)0x0);
  }
  param_2 = p_Var8;
  if (local_8) {
