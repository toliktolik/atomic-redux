/*
 * Function: STL_List_CopyConstructor
 * Address: 00452bf0
 * Category: misc
...

{
  ...
  piVar5 = (int *)DataStructure_AllocateNode
...
LAB_00452cf5:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x18) = 0;
        ...
        if (piVar8 == (int *)piVar2[2]) {
          Tree_RotateLeft(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x18) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x18) = 0;
        Tree_RotateRight(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[6] == '\0') goto LAB_00452cf5;
      if (piVar8 == (int *)*piVar2) {
        Tree_RotateRight(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x18) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x18) = 0;
      Tree_RotateLeft(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x18);
  } while( true );
}
