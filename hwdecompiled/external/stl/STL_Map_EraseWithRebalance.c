/*
 * Function: STL_Map_EraseWithRebalance
 * Address: 00453150
 * Category: misc
...
void STL_Map_EraseWithRebalance(undefined4 param_1,int *param_2)

{
  ...
  local_14 = piVar7;
  Iterator_ValidateAndAdvance((int *)&param_2);
  piVar10 = (int *)*piVar7;
  ...
  if (*(char *)((int)piVar10 + 0x19) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x19) != '\0') goto LAB_004531f8;
...
LAB_004531f8:
  if (piVar5 == piVar7) {
    ...
    if ((int *)**(int **)((int)local_18 + 4) == local_14) {
      if (*(char *)((int)piVar10 + 0x19) == '\0') {
        uVar13 = Tree_GetSuccessor(piVar10);
      }
    ...
    if (*(int **)(*(int *)((int)local_18 + 4) + 8) == local_14) {
      if (*(char *)((int)piVar10 + 0x19) == '\0') {
        uVar13 = Tree_GetPredecessor((int)piVar10);
        uVar9 = (uint)((ulonglong)uVar13 >> 0x20);
    ...
    *piVar5 = *piVar7;
    ...
    uVar9 = CONCAT31((int3)((uint)local_18 >> 8),(char)local_14[6]);
    *(char *)(piVar5 + 6) = (char)local_14[6];
    *(char *)(local_14 + 6) = (char)iVar2;
  }
  if ((char)local_14[6] == '\x01') {
    piVar7 = *(int **)((int)local_18 + 4);
        ...
        if (piVar10 == piVar5) {
          ...
          if ((char)piVar5[6] == '\0') {
            ...
            *(undefined1 *)(piVar11 + 6) = 0;
            Tree_RotateLeft(local_18,(int)piVar11);
            piVar5 = (int *)piVar11[2];
            uVar8 = extraout_var;
          }
          piVar7 = (int *)CONCAT31(uVar8,*(char *)((int)piVar5 + 0x19));
          if (*(char *)((int)piVar5 + 0x19) == '\0') {
            if ((*(char *)(*piVar5 + 0x18) != '\x01') ||
               (piVar7 = (int *)piVar5[2], (char)piVar7[6] != '\x01')) {
              if (*(char *)(piVar5[2] + 0x18) == '\x01') {
                *(undefined1 *)(*piVar5 + 0x18) = 1;
                *(undefined1 *)(piVar5 + 6) = 0;
                Tree_RotateRight(local_18,piVar5);
                piVar5 = (int *)piVar11[2];
              }
              *(char *)(piVar5 + 6) = (char)piVar11[6];
...
LAB_004533ac:
          ...
          if ((char)piVar5[6] == '\0') {
            *(undefined1 *)(piVar5 + 6) = 1;
            *(undefined1 *)(piVar11 + 6) = 0;
            Tree_RotateRight(local_18,piVar11);
            piVar5 = (int *)*piVar11;
          ...
          if (*(char *)((int)piVar5 + 0x19) == '\0') {
            if ((*(char *)(piVar5[2] + 0x18) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[6] == '\x01')) goto LAB_004533ac;
            if (*(char *)(*piVar5 + 0x18) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x18) = 1;
              *(undefined1 *)(piVar5 + 6) = 0;
              Tree_RotateLeft(local_18,(int)piVar5);
              piVar5 = (int *)*piVar11;
            }
            *(char *)(piVar5 + 6) = (char)piVar11[6];
            *(undefined1 *)(piVar11 + 6) = 1;
