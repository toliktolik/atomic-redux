...
void STL_Map_FindKey(undefined4 param_1,int *param_2)

{
  ...
  if (*(char *)((int)piVar10 + 0x11) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x11) != '\0') goto LAB_004534d8;
...
LAB_0045368c:
          ...
          if (*(char *)((int)piVar5 + 0x11) == '\0') {
            if ((*(char *)(piVar5[2] + 0x10) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[4] == '\x01')) goto LAB_0045368c;
            if (*(char *)(*piVar5 + 0x10) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x10) = 1;
              *(undefined1 *)(piVar5 + 4) = 0;
