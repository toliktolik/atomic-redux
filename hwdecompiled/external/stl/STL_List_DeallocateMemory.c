/*
 * Function: STL_List_DeallocateMemory
 * Address: 00452a30
 * Category: memory
...

{
  ...
  piVar5 = (int *)Tree_CalculateDepth(*(undefined4 *)((int)this + 4),param_3,
...
LAB_00452b35:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x20) = 0;
        ...
        if (piVar8 == (int *)piVar2[2]) {
          LinkedList_SkipInactiveNodes(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x20) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x20) = 0;
        LinkedList_TraverseAndFilter(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[8] == '\0') goto LAB_00452b35;
      if (piVar8 == (int *)*piVar2) {
        LinkedList_TraverseAndFilter(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x20) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x20) = 0;
      LinkedList_SkipInactiveNodes(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x20);
  } while( true );
}
