...

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  iVar3 = STL_List_PopFront((undefined1 *)(unaff_EBP + -0x58),(undefined4 *)(unaff_EBP + 0xc),
                            (int *)(unaff_EBP + 0x14));
  fVar6 = CRuntime_StringToFloat((char *)(unaff_EBP + -0x58),(char **)(unaff_EBP + -0x14),iVar3);
  *(double *)(unaff_EBP + -0x1c) = (double)fVar6;
