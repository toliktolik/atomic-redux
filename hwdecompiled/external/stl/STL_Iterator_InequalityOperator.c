/*
 * Function: STL_Iterator_InequalityOperator
 * Address: 00459440
 * Category: misc
...
void __thiscall
STL_Iterator_InequalityOperator(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if ((param_2 == (int *)*piVar6) && (param_3 == piVar6)) {
    STL_String_MoveConstructor(piVar6[1]);
  ...
  if (param_2 != param_3) {
    do {
      ...
      STL_String_ShrinkToFit(&param_2,piVar5);
      piVar5 = piVar6;
    } while (piVar6 != piVar3);
  }
  *param_1 = piVar6;
