/*
 * Function: STL_Algorithm_ForEach
 * Address: 004f38b1
 * Category: misc
...
void STL_Algorithm_ForEach(void)
  ...
  *(uint *)(unaff_EBP + -0x10) = uVar5;
  if ((bVar1 & 0x40) == 0) {
    ...
    *(undefined4 *)(unaff_EBP + -4) = 0xffffffff;
    ...
    Resource_LoadResource(unaff_EBP + -0x38,uVar5,'\0');
    STL_Iterator_Advance((_String_base *)(unaff_EBP + -0x38),extraout_EDX_01,p_Var6,0,0xffffffff);
    ...
    *(undefined4 *)(unaff_EBP + -4) = 4;
    if ((*(byte *)(unaff_EBP + -0x14) & 1) != 0) {
      Resource_LoadResource(unaff_EBP + -0x70,uVar5,'\x01');
    ...
    *puVar4 = *(undefined4 *)(unaff_EBP + 0xc);
    ...
    Resource_LoadResource(unaff_EBP + -0x38,uVar5,'\x01');
  }
