...
STL_StringAppend_1(_String_base *param_1,uint param_2,int param_3,uint param_4,uint param_5)

{
  ...
  if (param_5 != 0) {
    ...
    bVar1 = Resource_FindResource(param_1,param_2,uVar2,'\0');
    if (bVar1) {
