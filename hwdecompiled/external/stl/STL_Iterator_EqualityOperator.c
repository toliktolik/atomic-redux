/*
 * Function: STL_Iterator_EqualityOperator
 * Address: 00459380
 * Category: misc
...
void __thiscall
STL_Iterator_EqualityOperator(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if ((param_2 == (int *)*piVar6) && (param_3 == piVar6)) {
    STL_String_CopyConstructor(piVar6[1]);
