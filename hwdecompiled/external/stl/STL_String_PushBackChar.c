/*
 * Function: STL_String_PushBackChar
 * Address: 00457de0
 * Category: misc
...

{
  ...
  piVar5 = (int *)STL_String_GetData(*(undefined4 *)((int)this + 4),param_3,
...
LAB_00457ee5:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x2c) = 0;
        ...
        if (piVar8 == (int *)piVar2[2]) {
          XML_SetElementAttribute(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x2c) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x2c) = 0;
        XML_RemoveElement(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[0xb] == '\0') goto LAB_00457ee5;
      if (piVar8 == (int *)*piVar2) {
        XML_RemoveElement(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x2c) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x2c) = 0;
      XML_SetElementAttribute(this,*(int *)(piVar8[1] + 4));
    }
