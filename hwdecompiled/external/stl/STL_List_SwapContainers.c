/*
 * Function: STL_List_SwapContainers
 * Address: 00452e70
 * Category: enemies
...
void STL_List_SwapContainers(undefined4 param_1,int *param_2)

{
  ...
  local_14 = piVar7;
  Tree_FindMaximumNode((int *)&param_2);
  piVar10 = (int *)*piVar7;
  ...
  if (*(char *)((int)piVar10 + 0x21) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x21) != '\0') goto LAB_00452f18;
...
LAB_00452f18:
  if (piVar5 == piVar7) {
    ...
    if ((int *)**(int **)((int)local_18 + 4) == local_14) {
      if (*(char *)((int)piVar10 + 0x21) == '\0') {
        uVar13 = LinkedList_FindValidPointer(piVar10);
      }
    ...
    if (*(int **)(*(int *)((int)local_18 + 4) + 8) == local_14) {
      if (*(char *)((int)piVar10 + 0x21) == '\0') {
        uVar13 = Tree_UpdateNodeColors((int)piVar10);
        uVar9 = (uint)((ulonglong)uVar13 >> 0x20);
    ...
    *piVar5 = *piVar7;
    ...
    uVar9 = CONCAT31((int3)((uint)local_18 >> 8),(char)local_14[8]);
    *(char *)(piVar5 + 8) = (char)local_14[8];
    *(char *)(local_14 + 8) = (char)iVar2;
  }
  if ((char)local_14[8] == '\x01') {
    piVar7 = *(int **)((int)local_18 + 4);
        ...
        if (piVar10 == piVar5) {
          ...
          if ((char)piVar5[8] == '\0') {
            ...
            *(undefined1 *)(piVar11 + 8) = 0;
            LinkedList_SkipInactiveNodes(local_18,(int)piVar11);
            piVar5 = (int *)piVar11[2];
            uVar8 = extraout_var;
          }
          piVar7 = (int *)CONCAT31(uVar8,*(char *)((int)piVar5 + 0x21));
          if (*(char *)((int)piVar5 + 0x21) == '\0') {
            if ((*(char *)(*piVar5 + 0x20) != '\x01') ||
               (piVar7 = (int *)piVar5[2], (char)piVar7[8] != '\x01')) {
              if (*(char *)(piVar5[2] + 0x20) == '\x01') {
                *(undefined1 *)(*piVar5 + 0x20) = 1;
                *(undefined1 *)(piVar5 + 8) = 0;
                LinkedList_TraverseAndFilter(local_18,piVar5);
                piVar5 = (int *)piVar11[2];
              }
              *(char *)(piVar5 + 8) = (char)piVar11[8];
...
LAB_004530cc:
          ...
          if ((char)piVar5[8] == '\0') {
            *(undefined1 *)(piVar5 + 8) = 1;
            *(undefined1 *)(piVar11 + 8) = 0;
            LinkedList_TraverseAndFilter(local_18,piVar11);
            piVar5 = (int *)*piVar11;
          ...
          if (*(char *)((int)piVar5 + 0x21) == '\0') {
            if ((*(char *)(piVar5[2] + 0x20) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[8] == '\x01')) goto LAB_004530cc;
            if (*(char *)(*piVar5 + 0x20) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x20) = 1;
              *(undefined1 *)(piVar5 + 8) = 0;
              LinkedList_SkipInactiveNodes(local_18,(int)piVar5);
              piVar5 = (int *)*piVar11;
            }
            *(char *)(piVar5 + 8) = (char)piVar11[8];
            *(undefined1 *)(piVar11 + 8) = 1;
