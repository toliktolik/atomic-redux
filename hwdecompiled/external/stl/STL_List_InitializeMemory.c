/*
 * Function: STL_List_InitializeMemory
 * Address: 00452810
 * Category: memory
...
void __thiscall STL_List_InitializeMemory(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if (param_2 != param_3) {
    do {
      ...
      STL_Map_FindKey(&param_2,piVar5);
      piVar5 = piVar6;
    } while (piVar6 != piVar3);
  }
  *param_1 = piVar6;
