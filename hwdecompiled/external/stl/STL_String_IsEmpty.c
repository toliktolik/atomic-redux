...
void __thiscall STL_String_IsEmpty(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if ((param_2 == (int *)*piVar6) && (param_3 == piVar6)) {
    DataStructure_RecursiveDelete(piVar6[1]);
  ...
  if (param_2 != param_3) {
    do {
      ...
      STL_List_SwapContainers(&param_2,piVar5);
      piVar5 = piVar6;
    } while (piVar6 != piVar3);
  }
  *param_1 = piVar6;
