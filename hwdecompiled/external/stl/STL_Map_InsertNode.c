...
void __thiscall
STL_Map_InsertNode(void *this,undefined4 *param_1,char param_2,undefined4 *param_3,
...

{
  ...
  piVar5 = XML_CreateLargeNode(*(undefined4 *)((int)this + 4),param_3,*(undefined4 *)((int)this + 4)
                               ,param_4,0);
  *(int *)((int)this + 8) = *(int *)((int)this + 8) + 1;
  ...
  cVar1 = *(char *)(piVar5[1] + 0xd0);
  piVar8 = piVar5;
  do {
    if (cVar1 != '\0') {
      *(undefined1 *)(*(int *)(*(int *)((int)this + 4) + 4) + 0xd0) = 1;
      *param_1 = piVar5;
      ExceptionList = local_10;
      return;
    }
    ...
    if (piVar2 == piVar7) {
      ...
      if ((char)piVar7[0x34] == '\0') {
LAB_004a9d58:
        *(undefined1 *)(piVar2 + 0x34) = 1;
        *(undefined1 *)(piVar7 + 0x34) = 1;
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0xd0) = 0;
        piVar8 = *(int **)(*piVar6 + 4);
      }
      else {
        if (piVar8 == (int *)piVar2[2]) {
          Vector_Rotate(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0xd0) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0xd0) = 0;
        Vector_Transform(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[0x34] == '\0') goto LAB_004a9d58;
      if (piVar8 == (int *)*piVar2) {
        Vector_Transform(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0xd0) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0xd0) = 0;
      Vector_Rotate(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0xd0);
  } while( true );
}
