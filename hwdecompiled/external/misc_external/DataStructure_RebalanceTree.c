/*
 * Function: DataStructure_RebalanceTree
 * Address: 00451ea0
 * Category: misc
...
void DataStructure_RebalanceTree(undefined4 param_1,int *param_2)

{
  ...
  local_14 = piVar7;
  Threading_HandleMusicBuffer((int *)&param_2);
  piVar10 = (int *)*piVar7;
  ...
  if (*(char *)((int)piVar10 + 0x15) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x15) != '\0') goto LAB_00451f48;
...
LAB_00451f48:
  if (piVar5 == piVar7) {
    ...
    if ((int *)**(int **)((int)local_18 + 4) == local_14) {
      if (*(char *)((int)piVar10 + 0x15) == '\0') {
        uVar13 = Threading_UpdateMusicState(piVar10);
      }
    ...
    if (*(int **)(*(int *)((int)local_18 + 4) + 8) == local_14) {
      if (*(char *)((int)piVar10 + 0x15) == '\0') {
        uVar13 = Threading_ProcessMusicEvents((int)piVar10);
        uVar9 = (uint)((ulonglong)uVar13 >> 0x20);
    ...
    *piVar5 = *piVar7;
    ...
    uVar9 = CONCAT31((int3)((uint)local_18 >> 8),(char)local_14[5]);
    *(char *)(piVar5 + 5) = (char)local_14[5];
    *(char *)(local_14 + 5) = (char)iVar2;
  }
        ...
        if (piVar10 == piVar5) {
          ...
          if ((char)piVar5[5] == '\0') {
            ...
            *(undefined1 *)(piVar11 + 5) = 0;
            XML_CreateElement(local_18,(int)piVar11);
            piVar5 = (int *)piVar11[2];
            uVar8 = extraout_var;
          }
          piVar7 = (int *)CONCAT31(uVar8,*(char *)((int)piVar5 + 0x15));
          if (*(char *)((int)piVar5 + 0x15) == '\0') {
            if ((*(char *)(*piVar5 + 0x14) != '\x01') ||
               (piVar7 = (int *)piVar5[2], (char)piVar7[5] != '\x01')) {
              if (*(char *)(piVar5[2] + 0x14) == '\x01') {
                *(undefined1 *)(*piVar5 + 0x14) = 1;
                *(undefined1 *)(piVar5 + 5) = 0;
                Threading_SynchronizeMusicPlayback(local_18,piVar5);
                piVar5 = (int *)piVar11[2];
              }
              *(char *)(piVar5 + 5) = (char)piVar11[5];
...
LAB_004520fc:
          ...
          if ((char)piVar5[5] == '\0') {
            *(undefined1 *)(piVar5 + 5) = 1;
            *(undefined1 *)(piVar11 + 5) = 0;
            Threading_SynchronizeMusicPlayback(local_18,piVar11);
            piVar5 = (int *)*piVar11;
          ...
          if (*(char *)((int)piVar5 + 0x15) == '\0') {
            if ((*(char *)(piVar5[2] + 0x14) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[5] == '\x01')) goto LAB_004520fc;
            if (*(char *)(*piVar5 + 0x14) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x14) = 1;
              *(undefined1 *)(piVar5 + 5) = 0;
              XML_CreateElement(local_18,(int)piVar5);
              piVar5 = (int *)*piVar11;
            }
            *(char *)(piVar5 + 5) = (char)piVar11[5];
            *(undefined1 *)(piVar11 + 5) = 1;
