...
void Memory_CopyBuffer(int *param_1,int param_2,int param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  *puVar3 = 0;
  ...
  local_8 = 0;
  iVar5 = Memory_ReallocateBuffer(&stack0xffffffa0,&param_2,&param_4,plVar4);
  fVar8 = CRuntime_StringToFloat(&stack0xffffffa0,&local_1c,iVar5);
  pvVar1 = param_6;
  local_8 = 0xffffffff;
  if (param_6 != (void *)0x0) {
  ...
  if (local_1c != &stack0xffffffa0) {
    piVar7 = (int *)System_GetSystemInfo();
    if (*piVar7 == 0) {
      *param_8 = (double)fVar8;
      goto LAB_004805db;
    }
  }
  *puVar2 = *puVar2 | 2;
LAB_004805db:
  *param_1 = param_2;
  param_1[1] = param_3;
  ExceptionList = local_10;
  Exception_SetMessage((void *)(local_14 ^ unaff_retaddr),in_stack_ffffffa0,in_stack_ffffffa4);
  return;
}
