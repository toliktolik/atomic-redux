/*
 * Function: AudioCodec_ResampleAudio
 * Address: 004b7430
 * Category: audio
...
void __thiscall AudioCodec_ResampleAudio(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if ((param_2 == (int *)*piVar6) && (param_3 == piVar6)) {
    AudioCodec_GetSampleRate(piVar6[1]);
  ...
  if (param_2 != param_3) {
    do {
      ...
      AudioCodec_GetPitch(&param_2,piVar5);
      piVar5 = piVar6;
    } while (piVar6 != piVar3);
  }
  *param_1 = piVar6;
