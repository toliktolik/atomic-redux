/*
 * Function: Memory_CustomAllocator
 * Address: 004eeda5
 * Category: memory
...
facet * Memory_CustomAllocator(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  ...
  if ((this == (facet *)0x0) && (this = DAT_005a4914, DAT_005a4914 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a4914;
    RefCount_Increment((int)DAT_005a4914);
