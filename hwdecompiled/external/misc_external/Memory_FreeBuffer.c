...
void Memory_FreeBuffer(int *param_1,int param_2,int param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  *puVar3 = 0;
  ...
  dVar8 = CRuntime_StringToDouble(&stack0xffffffa0,&local_1c,iVar5);
  pvVar1 = param_6;
  local_8 = 0xffffffff;
  if (param_6 != (void *)0x0) {
