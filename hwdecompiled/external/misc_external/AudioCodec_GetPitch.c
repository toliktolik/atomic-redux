...
void AudioCodec_GetPitch(undefined4 param_1,int *param_2)

{
  ...
  if (*(char *)((int)piVar10 + 0x41) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x41) != '\0') goto LAB_004b6488;
...
LAB_004b663c:
          ...
          if (*(char *)((int)piVar5 + 0x41) == '\0') {
            if ((*(char *)(piVar5[2] + 0x40) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[0x10] == '\x01')) goto LAB_004b663c;
            if (*(char *)(*piVar5 + 0x40) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x40) = 1;
              *(undefined1 *)(piVar5 + 0x10) = 0;
