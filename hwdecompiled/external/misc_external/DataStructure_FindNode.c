/*
 * Function: DataStructure_FindNode
 * Address: 0044fcd0
 * Category: misc
...
undefined4 * __thiscall DataStructure_FindNode(void *this,int param_1)
...
LAB_0044fd5f:
      ...
      if (uVar6 == 0) goto LAB_0044fd50;
LAB_0044fd5d:
      if ((int)uVar6 < 0) goto LAB_0044fd5f;
