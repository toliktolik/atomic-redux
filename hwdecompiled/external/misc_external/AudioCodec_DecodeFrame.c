/*
 * Function: AudioCodec_DecodeFrame
 * Address: 004b7370
 * Category: audio
...
void __thiscall AudioCodec_DecodeFrame(void *this,undefined4 *param_1,int *param_2,int *param_3)

{
  ...
  if ((param_2 == (int *)*piVar6) && (param_3 == piVar6)) {
    AudioCodec_GetChannels(piVar6[1]);
