/*
 * Function: Memory_StackAllocator
 * Address: 004eed04
 * Category: memory
...
facet * Memory_StackAllocator(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  ...
  if ((this == (facet *)0x0) && (this = DAT_005a4910, DAT_005a4910 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a4910;
    RefCount_Increment((int)DAT_005a4910);
