/*
 * Function: DataStructure_RemoveRange
 * Address: 00452610
 * Category: misc
...
void __thiscall DataStructure_RemoveRange(void *this,undefined4 *param_1,int *param_2,int *param_3)
