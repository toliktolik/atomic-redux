/*
 * Function: Database_CloseConnection
 * Address: 0047ea50
 * Category: misc
...
void Database_CloseConnection(undefined4 param_1,int *param_2)

{
  ...
  local_14 = piVar7;
  Threading_UpdateAudioVolume((int *)&param_2);
  piVar10 = (int *)*piVar7;
  ...
  if (*(char *)((int)piVar10 + 0x11) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x11) != '\0') goto LAB_0047eaf8;
...
LAB_0047eaf8:
  if (piVar5 == piVar7) {
    ...
    if ((int *)**(int **)((int)local_18 + 4) == local_14) {
      if (*(char *)((int)piVar10 + 0x11) == '\0') {
        uVar13 = Threading_MixAudioChannels(piVar10);
      }
    ...
    if (*(int **)(*(int *)((int)local_18 + 4) + 8) == local_14) {
      if (*(char *)((int)piVar10 + 0x11) == '\0') {
        uVar13 = Threading_ProcessAudioSamples((int)piVar10);
        uVar9 = (uint)((ulonglong)uVar13 >> 0x20);
    ...
    *piVar5 = *piVar7;
    ...
    uVar9 = CONCAT31((int3)((uint)local_18 >> 8),(char)local_14[4]);
    *(char *)(piVar5 + 4) = (char)local_14[4];
    *(char *)(local_14 + 4) = (char)iVar2;
  }
  if ((char)local_14[4] == '\x01') {
    piVar7 = *(int **)((int)local_18 + 4);
        ...
        if (piVar10 == piVar5) {
          ...
          if ((char)piVar5[4] == '\0') {
            ...
            *(undefined1 *)(piVar11 + 4) = 0;
            XML_GetElementAttribute(local_18,(int)piVar11);
            piVar5 = (int *)piVar11[2];
            uVar8 = extraout_var;
          }
          piVar7 = (int *)CONCAT31(uVar8,*(char *)((int)piVar5 + 0x11));
          if (*(char *)((int)piVar5 + 0x11) == '\0') {
            if ((*(char *)(*piVar5 + 0x10) != '\x01') ||
               (piVar7 = (int *)piVar5[2], (char)piVar7[4] != '\x01')) {
              if (*(char *)(piVar5[2] + 0x10) == '\x01') {
                *(undefined1 *)(*piVar5 + 0x10) = 1;
                *(undefined1 *)(piVar5 + 4) = 0;
                LinkedList_RemoveNode(local_18,piVar5);
                piVar5 = (int *)piVar11[2];
              }
              *(char *)(piVar5 + 4) = (char)piVar11[4];
...
LAB_0047ecac:
          ...
          if ((char)piVar5[4] == '\0') {
            *(undefined1 *)(piVar5 + 4) = 1;
            *(undefined1 *)(piVar11 + 4) = 0;
            LinkedList_RemoveNode(local_18,piVar11);
            piVar5 = (int *)*piVar11;
          ...
          if (*(char *)((int)piVar5 + 0x11) == '\0') {
            if ((*(char *)(piVar5[2] + 0x10) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[4] == '\x01')) goto LAB_0047ecac;
            if (*(char *)(*piVar5 + 0x10) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x10) = 1;
              *(undefined1 *)(piVar5 + 4) = 0;
              XML_GetElementAttribute(local_18,(int)piVar5);
              piVar5 = (int *)*piVar11;
            }
            *(char *)(piVar5 + 4) = (char)piVar11[4];
            *(undefined1 *)(piVar11 + 4) = 1;
