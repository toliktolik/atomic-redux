...
undefined4 * __thiscall List_RemoveNode(void *this,int param_1)
...
LAB_00499c8f:
      ...
      if (uVar6 == 0) goto LAB_00499c80;
LAB_00499c8d:
      if ((int)uVar6 < 0) goto LAB_00499c8f;
      puVar4 = (undefined4 *)*puVar3;
      local_8 = puVar3;
    }
    puVar3 = puVar4;
    if (*(char *)((int)puVar4 + 0xd1) != '\0') {
      return local_8;
    }
  } while( true );
}
