...
undefined1 * __fastcall Unwind_00512ea3(uint param_1,char *param_2)

{
  ...
  do {
    uVar13 = unaff_ESI;
    bVar17 = CARRY4(param_1,*(uint *)((int)unaff_EDI + 0x7b69d3b5));
    if (SCARRY4(param_1,*(uint *)((int)unaff_EDI + 0x7b69d3b5))) {
      uRamcca4f6e7 = (undefined1)(CONCAT11(bVar17,uRamcca4f6e7) >> 1);
code_r0x00512f08:
      pcVar8 = (code *)swi(0xe2);
      (*pcVar8)();
code_r0x00512f0f:
      do {
        uStack_11 = (undefined1)in_CS;
        uStack_10 = (undefined1)((ushort)in_CS >> 8);
        in_CS = 0xf2fd;
        ...
        *puVar1 = *puVar1 ^ (uint)&uStack_10;
        uVar13 = CONCAT31((int3)(char)((byte)((ushort)uVar11 >> 8) | bVar9),(char)uVar11) |
                 0x7ff17bae;
        bVar17 = -1 < (int)(uVar16 & *(uint *)(CONCAT13(uStack_11,0x512f) + 0xd));
        if (bVar17) {
          if (!bVar17) {
            pcVar8 = (code *)swi(1);
          ...
          uStack_10 = (undefined1)in_CS;
          uStack_f = (undefined1)((ushort)in_CS >> 8);
    ...
    bVar9 = (byte)param_2;
    param_2 = (char *)CONCAT22((short)((uint)param_2 >> 0x10),CONCAT11(0xfd,bVar9));
    in_EAX = CONCAT31((int3)((uint)in_EAX >> 8),(char)in_EAX + -3 + bVar17);
    *(char *)(in_EAX + -0x1b95e7a) = *(char *)(in_EAX + -0x1b95e7a) + -0x45;
    param_1 = 0x9d2f8a20;
    unaff_EDI = unaff_EDI + 1;
    _DAT_b47af302 = param_2;
    *param_2 = *param_2 - (char)unaff_EBX;
    unaff_ESI = uVar13 + 4 | 0x45241cd7;
    uStack_c = uVar13;
    uStack_8 = uVar13;
    if ((param_2[0x7b161771] & bVar9) == 0) {
      ...
      *puVar14 = 0;
      if ((POPCOUNT(*puVar14) & 1U) == 0) {
        bVar17 = puVar12 < &DAT_14091534;
        if ((int)puVar12 < 0x14091534) {
          uVar10 = in(0xf8);
          puVar12 = (undefined1 *)CONCAT31(uVar15,uVar10);
          unaff_EDI = (undefined4 *)((int)unaff_EDI + (-(uint)bVar17 - uVar13));
        }
        puVar14 = puVar12 + -0x8e6071c;
        piVar2 = (int *)(uVar13 + 0x65e6be2a);
        iVar6 = *piVar2;
        iVar4 = *piVar2;
