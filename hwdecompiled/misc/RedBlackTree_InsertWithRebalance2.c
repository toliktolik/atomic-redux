/*
 * Function: RedBlackTree_InsertWithRebalance2
 * Address: 004a32a0
 * Category: misc
...
void __thiscall
RedBlackTree_InsertWithRebalance2
...

{
  ...
  piVar5 = (int *)Input_GetMouseY(*(undefined4 *)((int)this + 4),param_3,
  ...
  *(int *)((int)this + 8) = *(int *)((int)this + 8) + 1;
  ...
  do {
    if (cVar1 != '\0') {
      *(undefined1 *)(*(int *)(*(int *)((int)this + 4) + 4) + 0x34) = 1;
      *param_1 = piVar5;
      ExceptionList = local_10;
      return;
    }
...
LAB_004a33a5:
        *(undefined1 *)(piVar2 + 0xd) = 1;
        *(undefined1 *)(piVar7 + 0xd) = 1;
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x34) = 0;
        piVar8 = *(int **)(*piVar6 + 4);
      }
      else {
        if (piVar8 == (int *)piVar2[2]) {
          Animation_UpdateFrame(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x34) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x34) = 0;
        Animation_DrawFrame(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[0xd] == '\0') goto LAB_004a33a5;
      if (piVar8 == (int *)*piVar2) {
        Animation_DrawFrame(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x34) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x34) = 0;
      Animation_UpdateFrame(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x34);
  } while( true );
}
