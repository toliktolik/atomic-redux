...
float10 __fastcall Unwind_005105f0(uint param_1,uint param_2)

{
  ...
  iVar8 = (in_EAX + -0x721339d2) - (uint)in_CF;
  *unaff_EDI = unaff_BL + '\x01';
  iVar13 = *(int *)(param_1 * 3 + -0xb) * -0xb;
  bVar2 = 9 < ((byte)iVar8 & 0xf) | in_AF;
  uVar9 = CONCAT31((int3)((uint)iVar8 >> 8),(byte)iVar8 + bVar2 * '\x06') & 0xffffff0f;
  uVar10 = CONCAT22((short)(uVar9 >> 0x10),CONCAT11((char)((uint)iVar8 >> 8) + bVar2,(char)uVar9));
  bVar6 = (byte)param_1 & 0x1f;
  puVar16 = (undefined4 *)(unaff_ESI >> bVar6 | unaff_ESI << 0x20 - bVar6);
  bVar18 = (param_1 & 0x1f) != 0;
  uVar9 = (uint)(byte)(!bVar18 & bVar2 | (bVar18 && (int)puVar16 < 0));
  uVar1 = uVar10 + 0x6ecfd3b4;
  iVar8 = uVar1 + uVar9;
  uVar15 = unaff_EBP + 1;
  if (param_1 != 1 && uVar15 == 0) {
    ...
    iVar11 = CONCAT22((short)((uint)auStack_14 >> 0x10),CONCAT11(0xe3,(char)auStack_14));
    if (param_1 != 2 && uVar15 == 0) {
      if (uVar10 < 0x91302c4c && !CARRY4(uVar1,uVar9)) {
        *(double *)(unaff_EBP + -0x7b) = (double)in_ST0;
        *(undefined2 *)(unaff_EDI + iVar11 + -0x1699a8ba) = in_GS;
      }
      else {
        in(0x91);
        if (((uint)auStack_14 & 0x94) != 0 && -1 < (char)auStack_14) {
