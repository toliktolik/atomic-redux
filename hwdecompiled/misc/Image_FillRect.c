...
void Image_FillRect(undefined4 param_1,int *param_2)

{
  ...
  local_14 = piVar7;
  Animation_InitializeSystem((int *)&param_2);
  piVar10 = (int *)*piVar7;
  puVar6 = (uint *)(piVar7 + 2);
  uVar9 = extraout_EDX;
  piVar5 = piVar7;
  if (*(char *)((int)piVar10 + 0x59) == '\0') {
    uVar9 = *puVar6;
    if (*(char *)(uVar9 + 0x59) != '\0') goto LAB_0049b848;
...
LAB_0049b848:
  if (piVar5 == piVar7) {
    ...
    if ((int *)**(int **)((int)local_18 + 4) == local_14) {
      if (*(char *)((int)piVar10 + 0x59) == '\0') {
        uVar13 = Level_LoadAssets(piVar10);
      }
    ...
    if (*(int **)(*(int *)((int)local_18 + 4) + 8) == local_14) {
      if (*(char *)((int)piVar10 + 0x59) == '\0') {
        uVar13 = Level_SetBackground((int)piVar10);
        uVar9 = (uint)((ulonglong)uVar13 >> 0x20);
    ...
    *piVar5 = *piVar7;
    ...
    uVar9 = CONCAT31((int3)((uint)local_18 >> 8),(char)local_14[0x16]);
    *(char *)(piVar5 + 0x16) = (char)local_14[0x16];
    *(char *)(local_14 + 0x16) = (char)iVar2;
  }
  if ((char)local_14[0x16] == '\x01') {
    piVar7 = *(int **)((int)local_18 + 4);
    if (piVar10 != (int *)piVar7[1]) {
      do {
        if ((char)piVar10[0x16] != '\x01') break;
        piVar5 = (int *)*piVar11;
        uVar8 = (undefined3)((uint)piVar7 >> 8);
        if (piVar10 == piVar5) {
          piVar5 = (int *)piVar11[2];
          if ((char)piVar5[0x16] == '\0') {
            *(undefined1 *)(piVar5 + 0x16) = 1;
            *(undefined1 *)(piVar11 + 0x16) = 0;
            Vector_Normalize(local_18,(int)piVar11);
            piVar5 = (int *)piVar11[2];
            uVar8 = extraout_var;
          }
          piVar7 = (int *)CONCAT31(uVar8,*(char *)((int)piVar5 + 0x59));
          if (*(char *)((int)piVar5 + 0x59) == '\0') {
            if ((*(char *)(*piVar5 + 0x58) != '\x01') ||
               (piVar7 = (int *)piVar5[2], (char)piVar7[0x16] != '\x01')) {
              if (*(char *)(piVar5[2] + 0x58) == '\x01') {
                *(undefined1 *)(*piVar5 + 0x58) = 1;
                *(undefined1 *)(piVar5 + 0x16) = 0;
                Level_UnloadAssets(local_18,piVar5);
                piVar5 = (int *)piVar11[2];
              }
              *(char *)(piVar5 + 0x16) = (char)piVar11[0x16];
              *(undefined1 *)(piVar11 + 0x16) = 1;
              *(undefined1 *)(piVar5[2] + 0x58) = 1;
              Vector_Normalize(local_18,(int)piVar11);
              piVar7 = extraout_ECX;
...
LAB_0049b9fc:
          ...
          if ((char)piVar5[0x16] == '\0') {
            *(undefined1 *)(piVar5 + 0x16) = 1;
            *(undefined1 *)(piVar11 + 0x16) = 0;
            Level_UnloadAssets(local_18,piVar11);
            piVar5 = (int *)*piVar11;
          ...
          if (*(char *)((int)piVar5 + 0x59) == '\0') {
            if ((*(char *)(piVar5[2] + 0x58) == '\x01') &&
               (piVar7 = (int *)*piVar5, (char)piVar7[0x16] == '\x01')) goto LAB_0049b9fc;
            if (*(char *)(*piVar5 + 0x58) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x58) = 1;
              *(undefined1 *)(piVar5 + 0x16) = 0;
              Vector_Normalize(local_18,(int)piVar5);
              piVar5 = (int *)*piVar11;
            }
            *(char *)(piVar5 + 0x16) = (char)piVar11[0x16];
            *(undefined1 *)(piVar11 + 0x16) = 1;
