...
void Input_GetMouseX(undefined4 param_1,int *param_2)

{
  ...
  local_14 = piVar4;
  Collision_HandleBulletHit((int *)&param_2);
  piVar7 = (int *)*piVar4;
  piVar6 = piVar4 + 2;
  piVar9 = piVar4;
  if (*(char *)((int)piVar7 + 0x35) == '\0') {
    if (*(char *)(*piVar6 + 0x35) != '\0') goto LAB_004a1cd8;
    piVar6 = param_2 + 2;
    piVar9 = param_2;
  }
  piVar7 = (int *)*piVar6;
LAB_004a1cd8:
  if (piVar9 == piVar4) {
    ...
    if ((int *)**(int **)((int)local_18 + 4) == local_14) {
      piVar4 = piVar8;
      if (*(char *)((int)piVar7 + 0x35) == '\0') {
        piVar4 = (int *)Collision_CheckCircle(piVar7);
      }
      **(int **)((int)local_18 + 4) = (int)piVar4;
    }
    if (*(int **)(*(int *)((int)local_18 + 4) + 8) == local_14) {
      if (*(char *)((int)piVar7 + 0x35) == '\0') {
        uVar5 = Level_SetProgress((int)piVar7);
    ...
    *piVar9 = *piVar4;
    ...
    piVar9[1] = local_14[1];
    iVar1 = piVar9[0xd];
    *(char *)(piVar9 + 0xd) = (char)local_14[0xd];
    *(char *)(local_14 + 0xd) = (char)iVar1;
  }
  if ((char)local_14[0xd] == '\x01') {
        ...
        if (piVar7 == piVar4) {
          ...
          if ((char)piVar4[0xd] == '\0') {
            ...
            *(undefined1 *)(piVar8 + 0xd) = 0;
            Animation_UpdateFrame(local_18,(int)piVar8);
            piVar4 = (int *)piVar8[2];
          }
          if (*(char *)((int)piVar4 + 0x35) == '\0') {
            if ((*(char *)(*piVar4 + 0x34) != '\x01') || (*(char *)(piVar4[2] + 0x34) != '\x01')) {
              if (*(char *)(piVar4[2] + 0x34) == '\x01') {
                *(undefined1 *)(*piVar4 + 0x34) = 1;
                *(undefined1 *)(piVar4 + 0xd) = 0;
                Animation_DrawFrame(local_18,piVar4);
                piVar4 = (int *)piVar8[2];
              }
              *(char *)(piVar4 + 0xd) = (char)piVar8[0xd];
              *(undefined1 *)(piVar8 + 0xd) = 1;
              *(undefined1 *)(piVar4[2] + 0x34) = 1;
              Animation_UpdateFrame(local_18,(int)piVar8);
              break;
            }
LAB_004a1e8c:
          ...
          if ((char)piVar4[0xd] == '\0') {
            *(undefined1 *)(piVar4 + 0xd) = 1;
            *(undefined1 *)(piVar8 + 0xd) = 0;
            Animation_DrawFrame(local_18,piVar8);
            piVar4 = (int *)*piVar8;
          }
          if (*(char *)((int)piVar4 + 0x35) == '\0') {
            if ((*(char *)(piVar4[2] + 0x34) == '\x01') && (*(char *)(*piVar4 + 0x34) == '\x01'))
            goto LAB_004a1e8c;
            if (*(char *)(*piVar4 + 0x34) == '\x01') {
              *(undefined1 *)(piVar4[2] + 0x34) = 1;
              *(undefined1 *)(piVar4 + 0xd) = 0;
              Animation_UpdateFrame(local_18,(int)piVar4);
              piVar4 = (int *)*piVar8;
            }
            *(char *)(piVar4 + 0xd) = (char)piVar8[0xd];
            *(undefined1 *)(piVar8 + 0xd) = 1;
  ...
  piVar4 = local_14;
  piVar6 = local_14 + 5;
  if (0xf < (uint)local_14[0xb]) {
    String_GetDataPointer((int)piVar6);
    Memory_ThunkWrapper((int)piVar6,extraout_EDX);
  }
  piVar4[0xb] = 0xf;
  String_SetLength(piVar6,0);
