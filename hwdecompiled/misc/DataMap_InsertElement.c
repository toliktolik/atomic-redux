/*
 * Function: DataMap_InsertElement
 * Address: 00452290
 * Category: misc
...

{
  ...
  piVar5 = (int *)Memory_CheckAlignment
...
LAB_00452395:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x14) = 0;
        piVar8 = *(int **)(*piVar6 + 4);
      }
      else {
        if (piVar8 == (int *)piVar2[2]) {
          XML_CreateElement(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x14) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x14) = 0;
        Threading_SynchronizeMusicPlayback(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[5] == '\0') goto LAB_00452395;
      if (piVar8 == (int *)*piVar2) {
        Threading_SynchronizeMusicPlayback(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x14) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x14) = 0;
      XML_CreateElement(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x14);
  } while( true );
}
