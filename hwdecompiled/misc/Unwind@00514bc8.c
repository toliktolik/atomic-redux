...
void __fastcall Unwind_00514bc8(char *param_1,char *param_2)

{
  ...
  do {
    pcVar22 = unaff_ESI;
    bStack_4 = (byte)in_EAX;
    uStack_3 = (undefined1)((uint)in_EAX >> 8);
    uStack_2 = (undefined2)((uint)in_EAX >> 0x10);
    pcVar26 = unaff_EDI + (uint)bVar36 * -8 + 4;
    *(undefined4 *)unaff_EDI = in_EAX;
    pcVar27 = (char *)(CONCAT31((int3)(CONCAT22(uStack_2,CONCAT11(0x90,bStack_4)) >> 8),bStack_4) |
                      0x25);
    *(uint *)(unaff_EBX + -0xf) = *(uint *)(unaff_EBX + -0xf) | (uint)pcVar27;
    pcStack_8 = pcVar27;
    pcStack_c = param_1;
    pcStack_10 = param_2;
    ...
    pcStack_20 = pcVar22;
    pcStack_24 = pcVar26;
    uVar9 = (int)pcVar26 - (int)unaff_EBX;
    ...
    pcVar8 = (char *)((int)unaff_EBP + 0x7bc92438);
    bVar32 = (byte)param_1 & 0x1f;
    cVar3 = *pcVar8;
    *pcVar8 = *pcVar8 << bVar32;
    bVar4 = ((uint)param_1 & 0x1f) != 0;
    bVar31 = !bVar4 && pcVar26 < unaff_EBX || bVar4 && (char)(cVar3 << bVar32 - 1) < '\0';
    bVar37 = bVar32 != 1 && SBORROW4((int)pcVar26,(int)unaff_EBX) ||
             bVar32 == 1 && (bool)bVar31 != *pcVar8 < '\0';
    bVar4 = ((uint)param_1 & 0x1f) != 0;
    bVar35 = !bVar4 && (int)uVar9 < 0 || bVar4 && *pcVar8 < '\0';
    bVar34 = !bVar4 && uVar9 == 0 || bVar4 && *pcVar8 == '\0';
    bVar33 = !bVar4 && bVar33 || bVar4 && (POPCOUNT(*pcVar8) & 1U) == 0;
    param_2 = pcVar26;
code_r0x00514c19:
    if (!bVar34 && bVar37 == bVar35) {
      pbVar25 = unaff_EBP;
      if (bVar37) {
        piVar23 = (int *)CONCAT22((short)((uint)pcVar27 >> 0x10),CONCAT11(0xa3,(char)pcVar27));
        if (!bVar34 && bVar37 == bVar35) {
          *piVar23 = *piVar23 >> 1;
          return;
        }
        *(int *)(pcVar26 + -0x2a) = *(int *)(pcVar26 + -0x2a) - (int)param_1;
                    /* WARNING: Bad instruction - Truncating control flow here */
        halt_baddata();
      }
      do {
        ...
        puVar28 = (uint *)(pcVar8 + 0x5b25e658);
        uVar9 = *puVar28;
        uVar10 = *puVar28;
        ...
        *pcVar8 = *pcVar8 + -0x42 +
        ...
        pbVar19 = &bStack_4;
        unaff_EBP = &bStack_4;
        bStack_4 = (byte)pbVar25;
        uStack_3 = (undefined1)((uint)pbVar25 >> 8);
        uStack_2 = (undefined2)((uint)pbVar25 >> 0x10);
        cVar3 = '\f';
        do {
          pbVar25 = (byte *)((int)pbVar25 + -4);
          pbVar19 = (byte *)((int)pbVar19 + -4);
          *(undefined4 *)pbVar19 = *(undefined4 *)pbVar25;
          cVar3 = cVar3 + -1;
        } while ('\0' < cVar3);
        puStack_38 = &bStack_4;
        ...
        bVar31 = false;
        bVar37 = false;
        bVar32 = (byte)pcVar8 & 0xc9;
        pcVar27 = (char *)((uint)pcVar8 & 0xffffffc9);
        bVar35 = (char)bVar32 < '\0';
        bVar34 = ((uint)pcVar8 & 0xc9) == 0;
        bVar33 = (POPCOUNT(bVar32) & 1U) == 0;
        do {
          pcStack_1aa1 = pcVar8;
      ...
      pbVar25 = (byte *)((uint)&bStack_4 | (uint)pcVar11);
code_r0x00514c8f:
      uVar6 = *(undefined6 *)(pcVar11 + 0x1b5c9807);
      uVar30 = (undefined2)((uint6)uVar6 >> 0x20);
      out(0xec,pcVar11);
      pcVar27 = pcVar22 + 0x325f871d;
      cVar3 = *pcVar27;
      *pcVar27 = *pcVar27 - (char)param_2;
      piVar23 = (int *)(pcVar22 + (uint)bVar36 * -2 + 1);
      ...
      uVar21 = *(undefined4 *)pbVar25;
      bStack_4 = 0x1b;
      uStack_3 = 0x4d;
      uStack_2 = 0x51;
      uVar38 = (*(code *)(param_2 + 0x1d))();
      pcVar27 = pcVar26 + (uint)bVar36 * -2 + 1;
      bVar32 = (byte)uVar38;
      if (SBORROW1(bVar32,*pcVar26)) {
        uVar9 = CONCAT22((short)((uint6)uVar6 >> 0x10),
                         CONCAT11((char)((uint6)uVar6 >> 8) + *(char *)((ulonglong)uVar38 >> 0x20),
                                  (char)uVar6));
        pbVar19 = (byte *)((int)(pcVar27 + (uint)bVar36 * -2 + 1) + ((uint)bVar36 * -2 + 1) * 4);
        *(int *)(pcVar27 + (uint)bVar36 * -2 + 1) = *piVar23;
        pbVar25 = (byte *)(uVar9 - 0x2e);
        *pbVar25 = *pbVar25 << 1 | *pbVar25 >> 7;
        bVar31 = *pbVar25;
        cVar3 = *(char *)((int)uVar38 + -0x2a0e4518);
        *extraout_ECX = *extraout_ECX ^ uVar9;
        bStack_4 = (byte)in_SS;
        uStack_3 = (undefined1)((ushort)in_SS >> 8);
        ...
        *pbVar19 = *pbVar19 - 1;
        ...
        puVar24 = (undefined1 *)((int)piVar23 + (uint)bVar36 * -8 + 3);
        uVar9 = (uint)bVar32;
        puVar12 = (undefined1 *)((int)piVar23 + (uint)bVar36 * -8 + 0x29f53f96);
        pbVar25 = puVar12 + uVar9;
        uVar15 = (undefined2)((ulonglong)uVar38 >> 0x20);
        if ((SCARRY4((int)puVar24,0x29f53f93) != SCARRY4((int)puVar12,uVar9)) != (int)pbVar25 < 0) {
          ...
          *(uint *)(puVar16 + -0x3fbcdc63) =
               *(uint *)(puVar16 + -0x3fbcdc63) ^
               CONCAT31((int3)((ulonglong)uVar38 >> 8),
                        bVar32 + (0x9f < bVar32 |
                                 ((undefined1 *)0xd60ac06c < puVar24 || CARRY4((uint)puVar12,uVar9))
                                 | bVar36 * (bVar32 < 6)) * -0x60 +
        ...
        *pbVar1 = *pbVar1 << bVar32 | *pbVar1 >> 8 - bVar32;
        out(0xfe,(int)uVar38);
        if (*pbVar25 >= *pbVar19) {
          out(uVar15,(char)*(undefined4 *)(pbVar25 + (uint)bVar36 * -2 + 2));
          *(uint *)(pbVar25 + (uint)bVar36 * -8 + (uint)bVar36 * -2 + (int)&stack0x00000002 +
                   (*pbVar25 < *pbVar19)) =
               *(uint *)(pbVar25 + (uint)bVar36 * -8 + (uint)bVar36 * -2 + (int)&stack0x00000002 +
                        (*pbVar25 < *pbVar19)) ^ (uint)&bStack_4;
                    /* WARNING: Bad instruction - Truncating control flow here */
          halt_baddata();
        }
        ...
        uStack_3 = (undefined1)((uint)uVar21 >> 8);
        uStack_2 = (undefined2)((uint)uVar21 >> 0x10);
        pcVar5 = (code *)swi(0x43);
        uVar38 = (*pcVar5)();
        puVar16 = (undefined2 *)((ulonglong)uVar38 >> 0x20);
        puVar28 = (uint *)((int)pcVar27 * 0x200000);
        puVar17 = (undefined4 *)
                  *(undefined6 *)(extraout_ECX_01 + 0x14d442a4 + (int)pcVar27 * 0x800000);
        uVar9 = (uint)((int)pcVar27 * 0x100000 < 0);
        ...
        *(undefined2 *)(iVar14 + -4) = uVar30;
        if (auStack_5efb < (undefined1 *)0x5a557813 && !CARRY4((uint)&stack0xa5aa28f2,uVar9)) {
          if ((int)((uint)puVar17 & (uint)puVar28) < 1) {
            ...
            *piVar23 = (*piVar23 - (int)piVar23) - (uint)bVar33;
            ...
            puVar18 = (undefined4 *)
                      ...
                      (-(uint)(CONCAT31(uVar13,bVar31 + (0x90 < (bVar31 & 0xf0) |
                                                        ...
                                                        bVar32 * (0xf9 < bVar31)) * '`') <
                              0xb79e35cb) - *(int *)((int)piVar23 + 0xf)));
            puVar12 = (undefined1 *)CONCAT31(uVar13,uRamf0a18cd1);
            puVar29 = puVar28 + (uint)bVar36 * -2 + 1;
            puVar24 = (undefined1 *)*puVar28;
            iVar14 = extraout_ECX_02;
            do {
              iVar14 = iVar14 + -1;
              pbVar25 = (byte *)puVar17;
              puVar28 = puVar29;
            } while (iVar14 != 0 && puVar12 == puVar24);
          }
          *(undefined4 *)((int)pbVar25 + -0x3f3251b) = in_XMM1_Da;
          *(undefined4 *)((int)pbVar25 + -0x3f32517) = in_XMM1_Db;
          *(undefined4 *)((int)pbVar25 + -0x3f32513) = in_XMM1_Dc;
          *(undefined4 *)((int)pbVar25 + -0x3f3250f) = in_XMM1_Dd;
          ...
          *(int *)(puVar20 + -0x18) = (int)pbVar25 + 1;
          *(int **)(puVar20 + -0x1c) = piVar23;
    ...
    while( true ) {
      bVar32 = (byte)pcVar27;
      uVar13 = (undefined3)
               (CONCAT22((short)((uint)pcVar27 >> 0x10),CONCAT11(bVar32 / 0x66,bVar32)) >> 8);
      uVar7 = (ushort)CONCAT31(uVar13,bVar32 % 0x66);
      in_EAX = CONCAT31(uVar13,0x26);
      unaff_ESI = pcVar22 + -1;
      unaff_EDI = pcVar26;
      if (uVar7 == 0) break;
      iVar14 = in(0x5a);
      ...
      *puVar28 = (int)*puVar28 >> 1;
      ...
      pcVar26 = pcVar27 + (uint)bVar36 * -2 + 1;
      *pcVar27 = pcVar22[(uint)bVar36 * -2];
      bVar36 = 1;
      ...
      *param_2 = (char)((uint)param_1 >> 8);
      param_1 = (char *)CONCAT22((short)((uint)param_1 >> 0x10),CONCAT11(cVar3,(char)param_1));
      UNLOCK();
      unaff_EBX = param_2 + -1;
      pcVar27 = (char *)((iVar14 + 0x762820d6) - (uint)((uVar9 & 1) != 0));
      pcVar22 = (char *)0x9cea6bd8;
