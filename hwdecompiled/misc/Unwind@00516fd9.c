...
void __fastcall Unwind_00516fd9(int param_1,byte *param_2,uint param_3,undefined1 *param_4)

{
  ...
  while( true ) {
    ...
    *puVar1 = unaff_ESI;
    UNLOCK();
    pbVar14 = (byte *)CONCAT22((short)((uint)param_2 >> 0x10),CONCAT11(0x53,cVar13));
    unaff_ESI = puVar4;
    while( true ) {
      bVar16 = (param_3 & 0x40) != 0;
      bVar17 = (param_3 & 1) != 0;
      if (bVar16) {
        *(undefined2 *)pbVar14 = in_GS;
        pcVar7 = (code *)swi(1);
        (*pcVar7)();
        return;
      }
      iVar11 = iVar11 + -1;
      if (iVar11 != 0 && bVar16) break;
      uVar15 = (uint)bVar17;
      bVar17 = CARRY4((uint)unaff_retaddr,(uint)unaff_retaddr);
      bVar16 = SCARRY4((int)unaff_retaddr,(int)unaff_retaddr);
      uVar8 = (int)unaff_retaddr * 2;
      unaff_retaddr = (uint *)(uVar8 + uVar15);
      unaff_EBP = (int)_DAT_be6a9e40;
      *unaff_retaddr =
           *unaff_retaddr << 0xe |
           (uint)(CONCAT14((unaff_retaddr == (uint *)0x0 ||
                           (bVar16 != SCARRY4(uVar8,uVar15)) != (int)unaff_retaddr < 0) &&
                           (bVar17 || CARRY4(uVar8,uVar15)),*unaff_retaddr) >> 0x13);
      unaff_ESI = param_4;
    }
    sVar6 = ((ushort)unaff_ESI & 3) - ((ushort)iVar11 & 3);
    sVar10 = (ushort)iVar11 + (ushort)bVar17 * sVar6;
    ...
    fRamadc41f64 = fVar18;
    fRamadc41f6e = in_ST7;
    *puVar12 = *puVar12 << 1 | (uint)((int)uVar15 < 0);
    if ((int)uVar15 >= 0 && sVar6 < 1) {
      pcVar7 = (code *)swi(1);
      (*pcVar7)();
      return;
    }
    ...
    uVar15 = (uint)unaff_retaddr | *puVar12;
    *(uint *)(uVar15 - 0x1b) = *(uint *)(uVar15 - 0x1b) ^ 0xe4c50d2b;
    _DAT_0a02db66 = _DAT_0a02db66 & 0xe4c50d2b;
    bVar17 = SCARRY4(unaff_EBP,1);
    unaff_EBP = unaff_EBP + 1;
    out(0x92,pbVar14);
    if (bVar17 == unaff_EBP < 0) break;
    ...
    *pbVar2 = *pbVar2 + bVar9;
    ...
    if (param_1 == 0 || *pbVar2 != 0) goto code_r0x0051701c;
...
code_r0x0051701c:
  ...
  bVar17 = (byte)uVar15 < *pbVar14;
  pcVar3 = unaff_ESI + 0x1e;
  cVar13 = *pcVar3;
  cVar5 = *pcVar3 + (char)unaff_EBX;
  *pcVar3 = cVar5 + bVar17;
  if ((SCARRY1(cVar13,(char)unaff_EBX) != SCARRY1(cVar5,bVar17)) == *pcVar3 < '\0') {
    *(double *)(param_2 + 0x44) = (double)iVar11;
    *(undefined4 *)(uVar15 - 4) = 0xf;
    *(uint *)(uVar15 - 8) = uVar15 - 4;
