  ...
  if ((char)uVar5 == '\0') {
    ...
    if (wVar4 == wVar3) {
      ...
      *puVar6 = 0x2b;
      ...
      wVar4 = *(wint_t *)((int)this + 6);
      wVar3 = _btowc(0x2d);
      if (wVar4 != wVar3) goto LAB_004f015e;
      puVar6 = *(undefined1 **)(unaff_EBP + 8);
      *puVar6 = 0x2d;
    }
...
LAB_004f015e:
  ...
  *(undefined1 *)(unaff_EBP + 0x17) = 0;
  ...
  if ((char)uVar5 == '\0') {
    ...
    if (*(wint_t *)((int)this + 6) != wVar2) goto LAB_004f0241;
...
LAB_004f0234:
    ...
    if (wVar2 != wVar4) {
      ...
      if (wVar2 != wVar4) goto LAB_004f0234;
    }
...
LAB_004f0241:
    if (*(int *)(unaff_EBP + -0x14) != 0) {
LAB_004f0247:
      if (*(int *)(unaff_EBP + -0x14) != 10) goto LAB_004f024d;
    }
    ...
    *(undefined4 *)(unaff_EBP + -0x18) = *(undefined4 *)(unaff_EBP + 8);
    ...
    while ((iVar13 != 0 && (cVar1 = *pcVar11, cVar1 != '\x7f'))) {
      ...
      if (iVar13 != 0) {
        ...
        if (cVar1 != *(char *)(iVar9 + iVar13)) goto LAB_004f03db;
      }
      if (iVar13 == 0) {
        ...
        if (cVar1 < *pcVar10) goto LAB_004f03db;
      }
      if ('\0' < pcVar11[1]) {
        pcVar11 = pcVar11 + 1;
      }
