/*
 * Function: Locale_GetCodecvtFacet
 * Address: 004ee377
 * Category: misc
...
facet * Locale_GetCodecvtFacet(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  uVar1 = std::locale::id::Operator_CastToUnsignedInt((id *)&DAT_005a4984);
  this = std::locale::_Getfacet(*(locale **)(unaff_EBP + 8),uVar1);
  if ((this == (facet *)0x0) && (this = DAT_005a48f0, DAT_005a48f0 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a48f0;
    RefCount_Increment((int)DAT_005a48f0);
