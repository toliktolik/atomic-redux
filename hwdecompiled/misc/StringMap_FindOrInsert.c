/*
 * Function: StringMap_FindOrInsert
 * Address: 00407a90
 * Category: misc
...
void __thiscall StringMap_FindOrInsert(void *this,undefined4 *param_1,_String_base *param_2)

{
  ...
  local_8 = true;
  if ((*(_String_base **)(p_Var8 + 4))[0x45] == (_String_base)0x0) {
...
LAB_00407b07:
    ...
    } while (p_Var2[0x45] == (_String_base)0x0);
  }
  param_2 = p_Var8;
  if (local_8) {
    if (p_Var8 == (_String_base *)**(int **)((int)this + 4)) {
      puVar4 = (undefined4 *)
               Craft_ProcessJetFighter(this,&param_2,'\x01',(undefined4 *)p_Var8,p_Var1);
      *param_1 = *puVar4;
      *(undefined1 *)(param_1 + 1) = 1;
      return;
    }
    Iterator_DecrementWithValidation((int *)&param_2);
  }
  p_Var2 = param_2;
  ...
  puVar4 = (undefined4 *)Craft_ProcessJetFighter(this,&param_2,local_8,(undefined4 *)p_Var8,p_Var1);
  *param_1 = *puVar4;
  *(undefined1 *)(param_1 + 1) = 1;
  return;
}
