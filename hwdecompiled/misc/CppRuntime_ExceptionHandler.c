/*
 * Function: CppRuntime_ExceptionHandler
 * Address: 004eea80
 * Category: misc
...
facet * CppRuntime_ExceptionHandler(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  ...
  if ((this == (facet *)0x0) && (this = DAT_005a4900, DAT_005a4900 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a4900;
    RefCount_Increment((int)DAT_005a4900);
