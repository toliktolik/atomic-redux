/*
 * Function: Locale_GetWCharMoneyFacet
 * Address: 004ee55a
 * Category: misc
...
facet * Locale_GetWCharMoneyFacet(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  ...
  if ((this == (facet *)0x0) && (this = DAT_005a48fc, DAT_005a48fc == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a48fc;
    RefCount_Increment((int)DAT_005a48fc);
