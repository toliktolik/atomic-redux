/*
 * Function: Stream_LocaleProcessingWithFacets
 * Address: 0041fcd0
 * Category: misc
...
int * __thiscall Stream_LocaleProcessingWithFacets(void *this,undefined4 param_1)

{
  ...
  if (local_2c != '\0') {
    ...
    if ((char)local_38[0] != '\0') {
      ...
      piVar3 = (int *)Stream_ErrorCleanupHelper();
      return piVar3;
    }
  }
                    /* WARNING: Load size is inaccurate */
