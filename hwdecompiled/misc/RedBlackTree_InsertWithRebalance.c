/*
 * Function: RedBlackTree_InsertWithRebalance
 * Address: 004a30e0
 * Category: misc
...
void __thiscall
RedBlackTree_InsertWithRebalance
...

{
  ...
  piVar5 = (int *)Input_IsKeyReleased(*(undefined4 *)((int)this + 4),param_3,
...
LAB_004a31e5:
        ...
        *(undefined1 *)(*(int *)(*piVar6 + 4) + 0x30) = 0;
        piVar8 = *(int **)(*piVar6 + 4);
      }
      else {
        if (piVar8 == (int *)piVar2[2]) {
          Animation_SetLooping(this,(int)piVar2);
          piVar8 = piVar2;
        }
        *(undefined1 *)(piVar8[1] + 0x30) = 1;
        *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x30) = 0;
        Animation_SetSpeed(this,*(int **)(piVar8[1] + 4));
      }
    }
    else {
      if ((char)piVar7[0xc] == '\0') goto LAB_004a31e5;
      if (piVar8 == (int *)*piVar2) {
        Animation_SetSpeed(this,piVar2);
        piVar8 = piVar2;
      }
      *(undefined1 *)(piVar8[1] + 0x30) = 1;
      *(undefined1 *)(*(int *)(piVar8[1] + 4) + 0x30) = 0;
      Animation_SetLooping(this,*(int *)(piVar8[1] + 4));
    }
    cVar1 = *(char *)(piVar8[1] + 0x30);
  } while( true );
}
