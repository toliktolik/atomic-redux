/*
 * Function: CppRuntime_ResumeExecution
 * Address: 004f820f
 * Category: misc
...
facet * CppRuntime_ResumeExecution(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  uVar1 = std::locale::id::Operator_CastToUnsignedInt((id *)&DAT_005a49d8);
  this = std::locale::_Getfacet(*(locale **)(unaff_EBP + 8),uVar1);
  if ((this == (facet *)0x0) && (this = DAT_005a49b0, DAT_005a49b0 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a49b0;
    RefCount_Increment((int)DAT_005a49b0);
