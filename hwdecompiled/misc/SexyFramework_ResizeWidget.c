/*
 * Function: SexyFramework_ResizeWidget
 * Address: 004875c0
 * Category: misc
...
void __thiscall SexyFramework_ResizeWidget(void *this,undefined4 *param_1,_String_base *param_2)
...
LAB_00487637:
  ...
  if (local_8) {
    if (p_Var8 == (_String_base *)**(int **)((int)this + 4)) {
      puVar4 = (undefined4 *)Matrix_Translate(this,&param_2,'\x01',(undefined4 *)p_Var8,p_Var1);
      *param_1 = *puVar4;
      *(undefined1 *)(param_1 + 1) = 1;
      return;
    }
    XML_SaveDocument((int *)&param_2);
  }
  p_Var2 = param_2;
  ...
  puVar4 = (undefined4 *)Matrix_Translate(this,&param_2,local_8,(undefined4 *)p_Var8,p_Var1);
  *param_1 = *puVar4;
  *(undefined1 *)(param_1 + 1) = 1;
  return;
}
