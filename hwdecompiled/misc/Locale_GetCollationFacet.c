/*
 * Function: Locale_GetCollationFacet
 * Address: 004ee194
 * Category: misc
...
facet * Locale_GetCollationFacet(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  uVar1 = std::locale::id::Operator_CastToUnsignedInt((id *)&DAT_005a49a0);
  this = std::locale::_Getfacet(*(locale **)(unaff_EBP + 8),uVar1);
  if ((this == (facet *)0x0) && (this = DAT_005a48e4, DAT_005a48e4 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a48e4;
    RefCount_Increment((int)DAT_005a48e4);
