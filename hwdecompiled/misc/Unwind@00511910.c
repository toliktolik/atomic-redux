...
undefined2 * __fastcall Unwind_00511910(int param_1,undefined4 *param_2)

{
  ...
  out(0x95,(char)in_EAX);
  _DAT_4f2aea8b = in_EAX;
  *(int *)(unaff_EBX + 0x18d1fef7) = (int)ROUND(in_ST0);
  while( true ) {
    puVar11 = param_2;
    pbVar9 = (byte *)(param_1 + -0x79484278);
    *pbVar9 = *pbVar9 & (byte)puVar11;
    ...
    if ((char)*pbVar9 < '\x01') {
      ...
      *(uint *)(param_1 + -0x794842e0) = *(uint *)(param_1 + -0x794842e0) >> 1;
      do {
    ...
    uVar2 = *in_EAX;
    param_2 = (undefined4 *)((int)puVar11 + *in_EAX);
    ...
    *unaff_EDI = bVar4;
    ...
    param_1 = CONCAT31(uVar10,bVar5 + (0x90 < (bVar5 & 0xf0) |
  ...
  *unaff_EDI = bVar4;
  if (0 < (int)(*(uint *)(unaff_EBX + 0x10) & unaff_EBX)) {
    _DAT_f588bd97 = CONCAT22((short)(unaff_EBX >> 0x10),(short)in_EAX);
    *puVar8 = *puVar8;
