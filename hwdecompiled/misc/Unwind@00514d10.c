...
void __fastcall Unwind_00514d10(undefined4 param_1,int param_2)

{
  ...
  undefined8 uVar26;
  undefined1 auStack_5eff [24287];
  
  *(int *)(unaff_EBX + -0x2a) = *(int *)(unaff_EBX + -0x2a) + in_EAX;
  uVar26 = (*(code *)(param_2 + 0x1d))();
  pcVar2 = unaff_EDI + 1;
  bVar24 = (byte)uVar26;
  if (SBORROW1(bVar24,*unaff_EDI)) {
    uVar17 = CONCAT22((short)((uint)in_EAX >> 0x10),
                      CONCAT11((char)((uint)in_EAX >> 8) + *(char *)((ulonglong)uVar26 >> 0x20),
                               (char)in_EAX));
    ...
    *pbVar22 = *pbVar22 << 1 | *pbVar22 >> 7;
    bVar7 = *pbVar22;
    cVar8 = *(char *)((int)uVar26 + -0x2a0e4518);
    *extraout_ECX = *extraout_ECX ^ uVar17;
    bVar24 = 0xf < (byte)(bVar24 + cVar8 + ((bVar7 & 1) != 0));
    *pbVar4 = *pbVar4 - 1;
    ffree(in_ST7);
    uVar26 = func_0x11b54bd3();
    puVar16 = (undefined2 *)((ulonglong)uVar26 >> 0x20);
    uVar17 = (uint)bVar24;
    uVar9 = (int)unaff_ESI + 0x29f53f96;
    pbVar22 = (byte *)(uVar9 + uVar17);
    uVar15 = (undefined2)((ulonglong)uVar26 >> 0x20);
    if ((SCARRY4((int)unaff_ESI + 3U,0x29f53f93) != SCARRY4(uVar9,uVar17)) != (int)pbVar22 < 0) {
      in_AF = 9 < ((byte)uVar26 & 0xf) | in_AF;
      bVar24 = (byte)uVar26 + in_AF * -6;
      *(uint *)(puVar16 + -0x3fbcdc63) =
           *(uint *)(puVar16 + -0x3fbcdc63) ^
           CONCAT31((int3)((ulonglong)uVar26 >> 8),
                    bVar24 + (0x9f < bVar24 |
                             (0xd60ac06c < (int)unaff_ESI + 3U || CARRY4(uVar9,uVar17)) |
                             in_AF * (bVar24 < 6)) * -0x60 + (char)((ulonglong)uVar26 >> 8) * '~' +
                    'P') & 0xffff00ff;
    ...
    bVar24 = (byte)extraout_ECX_00 & 7;
    *pbVar1 = *pbVar1 << bVar24 | *pbVar1 >> 8 - bVar24;
    out(0xfe,(int)uVar26);
    if (*pbVar22 >= *pbVar4) {
      out(uVar15,(char)*(undefined4 *)(pbVar22 + 2));
      *(uint *)(pbVar22 + (int)&stack0xfffffffe + (*pbVar22 < *pbVar4)) =
           *(uint *)(pbVar22 + (int)&stack0xfffffffe + (*pbVar22 < *pbVar4)) ^
    ...
    pcVar10 = (code *)swi(0x43);
    uVar26 = (*pcVar10)();
    puVar16 = (undefined2 *)((ulonglong)uVar26 >> 0x20);
    puVar23 = (uint *)((int)pcVar2 * 0x200000);
    puVar18 = (undefined4 *)*(undefined6 *)(extraout_ECX_01 + 0x14d442a4 + (int)pcVar2 * 0x800000);
    uVar17 = (uint)((int)pcVar2 * 0x100000 < 0);
    puVar12 = &stack0xa5aa28ee + uVar17;
    iVar11 = *(int *)uVar26;
    puVar20 = (undefined1 *)(iVar11 + -4);
    *(undefined2 *)(iVar11 + -4) = in_ES;
    if (auStack_5eff < (undefined1 *)0x5a557813 && !CARRY4((uint)&stack0xa5aa28ee,uVar17)) {
      iVar14 = extraout_ECX_01;
      puVar19 = puVar18;
      if (0 < (int)((uint)puVar18 & (uint)puVar23)) {
        bVar25 = *(uint *)(extraout_ECX_01 + 0x19) < 0x6383ea3e;
        puVar20 = (undefined1 *)(iVar11 + -8);
        *(undefined4 *)(iVar11 + -8) = 0x514db1;
        ...
        *unaff_ESI = (*unaff_ESI - (int)unaff_ESI) - (uint)bVar25;
        ...
        bVar24 = (byte)uVar26 + in_AF * '\x06';
        puVar19 = (undefined4 *)
                  (puVar12 +
                  (-(uint)(CONCAT31(uVar13,bVar24 + (0x90 < (bVar24 & 0xf0) |
                                                    puVar18 < *(undefined4 **)
                                                               (puVar16 + (int)puVar12 * 4) |
                                                    in_AF * (0xf9 < bVar24)) * '`') < 0xb79e35cb) -
