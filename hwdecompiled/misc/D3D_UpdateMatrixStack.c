/*
 * Function: D3D_UpdateMatrixStack
 * Address: 00484320
 * Category: misc
...
void D3D_UpdateMatrixStack(undefined4 param_1,int *param_2)

{
  ...
  if (*(char *)((int)piVar11 + 0x2d) == '\0') {
    uVar10 = *puVar7;
    if (*(char *)(uVar10 + 0x2d) != '\0') goto LAB_004843c8;
        ...
        if (piVar11 == piVar5) {
          ...
          if ((char)piVar5[0xb] == '\0') {
            ...
            *(undefined1 *)(piVar12 + 0xb) = 0;
            LinkedList_InsertBefore(local_1c,(int)piVar12);
            piVar5 = (int *)piVar12[2];
            uVar9 = extraout_var;
          }
            ...
            if ((*(char *)(*piVar5 + 0x2c) != '\x01') ||
              ...
              if (*(char *)(piVar5[2] + 0x2c) == '\x01') {
                ...
                *(undefined1 *)(piVar5 + 0xb) = 0;
                LinkedList_InsertAfter(local_1c,piVar5);
                piVar5 = (int *)piVar12[2];
              }
...
LAB_0048457c:
          ...
          if ((char)piVar5[0xb] == '\0') {
            *(undefined1 *)(piVar5 + 0xb) = 1;
            *(undefined1 *)(piVar12 + 0xb) = 0;
            LinkedList_InsertAfter(local_1c,piVar12);
            piVar5 = (int *)*piVar12;
          ...
          if (*(char *)((int)piVar5 + 0x2d) == '\0') {
            if ((*(char *)(piVar5[2] + 0x2c) == '\x01') &&
               (piVar8 = (int *)*piVar5, (char)piVar8[0xb] == '\x01')) goto LAB_0048457c;
            if (*(char *)(*piVar5 + 0x2c) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x2c) = 1;
              *(undefined1 *)(piVar5 + 0xb) = 0;
              LinkedList_InsertBefore(local_1c,(int)piVar5);
              piVar5 = (int *)*piVar12;
            }
            *(char *)(piVar5 + 0xb) = (char)piVar12[0xb];
            *(undefined1 *)(piVar12 + 0xb) = 1;
