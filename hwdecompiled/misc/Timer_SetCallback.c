  ...
  *(uint *)(unaff_EBP + -0x10) = uVar2;
  if ((*(uint *)((int)this + 0xc) & 0x4000) == 0) {
    ...
    *(undefined4 *)(unaff_EBP + -4) = 0;
    this_00 = Log_WriteEntry();
    *(undefined4 *)(unaff_EBP + -4) = 0xffffffff;
    SmartPointer_Destructor((uint *)(unaff_EBP + 0x1c));
    Resource_LoadResource(unaff_EBP + -0x38,extraout_EDX,'\0');
    STL_StringAssign_1((_String_base *)(unaff_EBP + -0x38),extraout_EDX_00,1,0);
    *(undefined4 *)(unaff_EBP + -4) = 1;
    iVar3 = Resource_FreeResource(this_00,unaff_EBP + -0x54);
    *(undefined1 *)(unaff_EBP + -4) = 2;
    STL_StringAppend_1((_String_base *)(unaff_EBP + -0x38),extraout_EDX_01,iVar3,0,0xffffffff);
    *(undefined1 *)(unaff_EBP + -4) = 1;
    Resource_LoadResource(unaff_EBP + -0x54,extraout_EDX_02,'\x01');
    FID_conflict_append((_String_base *)(unaff_EBP + -0x38),extraout_EDX_03,1,0);
    iVar3 = STL_String_Insert(this_00,unaff_EBP + -0x54);
    *(undefined1 *)(unaff_EBP + -4) = 3;
    STL_StringAppend_1((_String_base *)(unaff_EBP + -0x38),extraout_EDX_04,iVar3,0,0xffffffff);
    *(undefined1 *)(unaff_EBP + -4) = 1;
    Resource_LoadResource(unaff_EBP + -0x54,extraout_EDX_05,'\x01');
    uVar7 = STL_String_Erase();
    *(undefined4 *)(unaff_EBP + -4) = 0xffffffff;
    *(int *)(unaff_EBP + -0x14) = (int)uVar7;
    Resource_LoadResource(unaff_EBP + -0x38,(uint)((ulonglong)uVar7 >> 0x20),'\x01');
  }
