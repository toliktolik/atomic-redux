...
void Image_Grayscale(undefined4 param_1,int *param_2)

{
  ...
  local_18 = piVar8;
  Collision_CheckPixelPerfect((int *)&param_2);
  piVar11 = (int *)*piVar8;
  ...
  if (*(char *)((int)piVar11 + 0x31) == '\0') {
    uVar10 = *puVar7;
    if (*(char *)(uVar10 + 0x31) != '\0') goto LAB_0049c1b8;
...
LAB_0049c1b8:
  if (piVar5 == piVar8) {
    ...
    if ((int *)**(int **)((int)local_1c + 4) == local_18) {
      if (*(char *)((int)piVar11 + 0x31) == '\0') {
        uVar14 = Collision_CheckBounds(piVar11);
      }
    ...
    if (*(int **)(*(int *)((int)local_1c + 4) + 8) == local_18) {
      if (*(char *)((int)piVar11 + 0x31) == '\0') {
        uVar14 = Level_GetProgress((int)piVar11);
        uVar10 = (uint)((ulonglong)uVar14 >> 0x20);
    ...
    *piVar5 = *piVar8;
    ...
    uVar10 = CONCAT31((int3)((uint)local_1c >> 8),(char)local_18[0xc]);
    *(char *)(piVar5 + 0xc) = (char)local_18[0xc];
    *(char *)(local_18 + 0xc) = (char)iVar2;
  }
  if ((char)local_18[0xc] == '\x01') {
    piVar8 = *(int **)((int)local_1c + 4);
    if (piVar11 != (int *)piVar8[1]) {
      do {
        if ((char)piVar11[0xc] != '\x01') break;
        piVar5 = (int *)*piVar12;
        ...
        if (piVar11 == piVar5) {
          ...
          if ((char)piVar5[0xc] == '\0') {
            ...
            *(undefined1 *)(piVar12 + 0xc) = 0;
            Animation_SetLooping(local_1c,(int)piVar12);
            piVar5 = (int *)piVar12[2];
            uVar9 = extraout_var;
          }
          piVar8 = (int *)CONCAT31(uVar9,*(char *)((int)piVar5 + 0x31));
          if (*(char *)((int)piVar5 + 0x31) == '\0') {
            if ((*(char *)(*piVar5 + 0x30) != '\x01') ||
               (piVar8 = (int *)piVar5[2], (char)piVar8[0xc] != '\x01')) {
              if (*(char *)(piVar5[2] + 0x30) == '\x01') {
                *(undefined1 *)(*piVar5 + 0x30) = 1;
                *(undefined1 *)(piVar5 + 0xc) = 0;
                Animation_SetSpeed(local_1c,piVar5);
                piVar5 = (int *)piVar12[2];
              }
              *(char *)(piVar5 + 0xc) = (char)piVar12[0xc];
...
LAB_0049c36c:
          ...
          if ((char)piVar5[0xc] == '\0') {
            *(undefined1 *)(piVar5 + 0xc) = 1;
            *(undefined1 *)(piVar12 + 0xc) = 0;
            Animation_SetSpeed(local_1c,piVar12);
            piVar5 = (int *)*piVar12;
          ...
          if (*(char *)((int)piVar5 + 0x31) == '\0') {
            if ((*(char *)(piVar5[2] + 0x30) == '\x01') &&
               (piVar8 = (int *)*piVar5, (char)piVar8[0xc] == '\x01')) goto LAB_0049c36c;
            if (*(char *)(*piVar5 + 0x30) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x30) = 1;
              *(undefined1 *)(piVar5 + 0xc) = 0;
              Animation_SetLooping(local_1c,(int)piVar5);
              piVar5 = (int *)*piVar12;
            }
            *(char *)(piVar5 + 0xc) = (char)piVar12[0xc];
            *(undefined1 *)(piVar12 + 0xc) = 1;
  ...
  if ((uint)local_18[0xb] < 0x10) {
    puVar15 = &local_11;
    local_18[0xb] = 0xf;
    local_11 = 0;
    local_18[10] = 0;
    puVar6 = (undefined1 *)String_GetDataPointer((int)(local_18 + 5));
