/*
 * Function: Vector_Insert_16ByteObjects_WithDestructors
 * Address: 0040afc0
 * Category: misc
...
void __thiscall
Vector_Insert_16ByteObjects_WithDestructors
...

{
  ...
  local_18 = this;
  Wave_CalculateLength(local_2c,(int)param_3);
  puVar7 = param_2;
  puVar2 = param_1;
  ...
  if (param_2 != (undefined1 *)0x0) {
    ...
    if ((undefined1 *)(0xfffffffU - (int)puVar5) < param_2) {
      ...
      if (puVar1 < param_2 + iVar6) {
        ...
        local_1c = puVar2;
        param_2 = (undefined1 *)
                  Survival_CalculateWaveTiming(*(int *)((int)this + 4),(int)param_1,puVar2);
        Survival_ProcessEnemyFormations(param_2,(int)puVar7,(int)local_2c);
        param_2 = param_2 + (int)puVar7 * 0x10;
        Survival_CalculateWaveTiming((int)param_1,*(int *)((int)this + 8),param_2);
        ...
        if (iVar6 != 0) {
          Survival_ProcessUltimateChallenge
                    (this,*(uint *)((int)this + 8),iVar6,*(uint *)((int)this + 8));
        ...
        *(undefined1 **)((int)this + 8) = puVar2 + (int)(puVar7 + iVar3) * 0x10;
        ...
        if ((undefined1 *)((int)local_1c - (int)param_1 >> 4) < param_2) {
          ...
          Survival_ProcessPowerUpDrops((int)param_1,(int)puVar5,param_3 + (int)param_1);
          local_8 = CONCAT31(local_8._1_3_,3);
          Survival_ProcessScoreMultipliers
                    (*(void **)((int)this + 8),
          ...
          *(undefined1 **)((int)this + 8) = param_3 + iVar6;
          ...
          uVar4 = Survival_ProcessPowerUpDrops((int)puVar5,(int)local_1c,local_1c);
          *(undefined4 *)((int)this + 8) = uVar4;
          param_1 = &stack0xffffffbc;
          MemoryCopy_Backward_16ByteObjects_Wrapper
        ...
        param_1 = &stack0xffffffbc;
        ArrayInit_16ByteObjects(puVar7,(uint)puVar5,(int)puVar2,(int)puVar1,(int)local_2c);
  ...
  iVar6 = iStack_28;
  if (iStack_28 != 0) {
    for (; iVar6 != iStack_24; iVar6 = iVar6 + 0x28) {
      DualDataStructure_Destructor(iVar6,uVar8,0);
