/*
 * Function: D3D_TestAlphaBlending
 * Address: 00485450
 * Category: misc
...
undefined1 __fastcall D3D_TestAlphaBlending(int param_1)

{
  ...
  D3D_CreateVertexBuffer
            (local_30,*(_String_base **)(param_1 + 0x18),*(_String_base **)(param_1 + 0xc),0,0,
             0xffffffff);
  Image_FillRectangle(local_30,0,0,0x40,0x40,0x80ff0000);
  D3D_CreateVertexBuffer
            (local_30,*(_String_base **)(param_1 + 0x18),*(_String_base **)(param_1 + 0xc),0,0,
             0xffffffff);
  ...
  if (local_1c[0] == 0) {
    ...
    pcVar1 = "Alpha blend test not uniform.";
    do {
      pcVar5 = pcVar1;
      pcVar1 = pcVar5 + 1;
    } while (*pcVar5 != '\0');
    String_Assign(local_3c,(_String_base *)"Alpha blend test not uniform.",
                  (uint)(pcVar5 + -0x53360c));
    local_8 = 3;
    ...
    pcVar1 = "Alpha blend Not Supported";
    do {
      pcVar5 = pcVar1;
      pcVar1 = pcVar5 + 1;
    } while (*pcVar5 != '\0');
    String_Assign(local_58,(_String_base *)"Alpha blend Not Supported",(uint)(pcVar5 + -0x5335f0));
    local_8 = 4;
