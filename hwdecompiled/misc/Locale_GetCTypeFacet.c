...
facet * Locale_GetCTypeFacet(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  ...
  if ((this == (facet *)0x0) && (this = DAT_005a48ec, DAT_005a48ec == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a48ec;
    RefCount_Increment((int)DAT_005a48ec);
