/*
 * Function: Compiler_BufferOverflowCheck
 * Address: 004f5704
 * Category: misc
...
void Compiler_BufferOverflowCheck(void)

{
  ...
  *(undefined1 *)(unaff_EBP + -4) = 3;
  ...
  if (uVar7 < *(uint *)(unaff_EBP + 0x38)) {
    ...
    if ('\0' < *pcVar8) {
      ...
      while (((cVar1 = *pcVar8, cVar1 != '\x7f' && ('\0' < cVar1)) && ((uint)(int)cVar1 < uVar7))) {
        ...
        Compiler_FloatingPointInit((_String_base *)(unaff_EBP + 0x24),uVar14,uVar7,1,uVar5);
  ...
  Resource_LoadResource(unaff_EBP + -0x84,uVar14,'\0');
  ...
  *(undefined1 *)(unaff_EBP + -4) = 4;
  ...
  STL_Iterator_Advance((_String_base *)(unaff_EBP + -0x84),uVar14,p_Var9,0,0xffffffff);
  Resource_LoadResource(unaff_EBP + -0xd8,extraout_EDX_04,'\x01');
  Resource_LoadResource(unaff_EBP + -0xa0,extraout_EDX_05,'\0');
  ...
  *(undefined1 *)(unaff_EBP + -4) = 7;
  if ((uVar14 & 8) != 0) {
    ...
    *(undefined1 *)(unaff_EBP + -4) = 8;
    STL_Iterator_Advance((_String_base *)(unaff_EBP + -0xa0),extraout_EDX_06,p_Var9,0,0xffffffff);
    *(undefined1 *)(unaff_EBP + -4) = 7;
    Resource_LoadResource(unaff_EBP + -0xd8,extraout_EDX_07,'\x01');
  }
  ...
  *(undefined4 *)(unaff_EBP + -0x18) = 0;
  ...
  do {
    ...
    if (cVar1 == ' ') {
      if (*(int *)(unaff_EBP + -0x68) != 0x100) goto LAB_004f5ba0;
    ...
    *(int *)(unaff_EBP + -0x18) = *(int *)(unaff_EBP + -0x18) + 1;
    if (3 < *(uint *)(unaff_EBP + -0x18)) {
      ...
      *puVar3 = *(undefined4 *)(unaff_EBP + 0xc);
      ...
      Resource_LoadResource(unaff_EBP + -0xa0,uVar7,'\x01');
      Resource_LoadResource(unaff_EBP + -0x84,extraout_EDX_09,'\x01');
      String_Reset(unaff_EBP + -0xbc,extraout_EDX_10,'\x01');
      Resource_LoadResource(unaff_EBP + 0x24,extraout_EDX_11,'\x01');
