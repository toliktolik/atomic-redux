/*
 * Function: D3D_MultiplyTransform
 * Address: 00483970
 * Category: misc
...
void D3D_MultiplyTransform(undefined4 param_1,int *param_2)

{
  ...
  if (*(char *)((int)piVar11 + 0x2d) == '\0') {
    uVar10 = *puVar7;
    if (*(char *)(uVar10 + 0x2d) != '\0') goto LAB_00483a18;
...
LAB_00483bcc:
          ...
          if (*(char *)((int)piVar5 + 0x2d) == '\0') {
            if ((*(char *)(piVar5[2] + 0x2c) == '\x01') &&
               (piVar8 = (int *)*piVar5, (char)piVar8[0xb] == '\x01')) goto LAB_00483bcc;
            if (*(char *)(*piVar5 + 0x2c) == '\x01') {
              *(undefined1 *)(piVar5[2] + 0x2c) = 1;
              *(undefined1 *)(piVar5 + 0xb) = 0;
