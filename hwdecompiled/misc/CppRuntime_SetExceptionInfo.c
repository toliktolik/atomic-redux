/*
 * Function: CppRuntime_SetExceptionInfo
 * Address: 004f8351
 * Category: misc
...
facet * CppRuntime_SetExceptionInfo(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  uVar1 = std::locale::id::Operator_CastToUnsignedInt((id *)&DAT_005a49e4);
  this = std::locale::_Getfacet(*(locale **)(unaff_EBP + 8),uVar1);
  if ((this == (facet *)0x0) && (this = DAT_005a49b8, DAT_005a49b8 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a49b8;
    RefCount_Increment((int)DAT_005a49b8);
