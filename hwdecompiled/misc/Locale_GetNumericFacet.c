/*
 * Function: Locale_GetNumericFacet
 * Address: 004edfb1
 * Category: misc
...
facet * Locale_GetNumericFacet(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  ...
  if ((this == (facet *)0x0) && (this = DAT_005a48d8, DAT_005a48d8 == (facet *)0x0)) {
    iVar2 = Getcat();
    if (iVar2 == -1) {
    ...
    this = DAT_005a48d8;
    RefCount_Increment((int)DAT_005a48d8);
