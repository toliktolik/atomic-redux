/*
 * Function: D3DRenderer_TestAlphaModulation
 * Address: 00485c00
 * Category: graphics
...
undefined1 __fastcall D3DRenderer_TestAlphaModulation(int param_1)

{
  ...
  iVar4 = (**(code **)(**(int **)(param_1 + 0x18) + 0x50))(*(int **)(param_1 + 0x18),0x14,6);
  D3D_ValidateRenderTarget(iVar4,(_String_base *)"D3DRENDERSTATE_DESTBLEND, D3DBLEND_INVSRCALPHA");
  ...
  iVar4 = (**(code **)(**(int **)(param_1 + 0x18) + 0x94))(*(int **)(param_1 + 0x18),0,4,4);
  D3D_ValidateRenderTarget(iVar4,(_String_base *)"D3DTSS_ALPHAOP, D3DTOP_MODULATE");
  DirectX_ValidateDisplayMode(local_30,extraout_EDX,0x40,0x40);
  local_8 = CONCAT31(local_8._1_3_,1);
  Image_FillRectangle(local_30,0,0,0x40,0x40,0xff0000ff);
  D3D_CreateVertexBuffer
            (local_30,*(_String_base **)(param_1 + 0x18),*(_String_base **)(param_1 + 0xc),0,0,
             0xffffffff);
  Image_FillRectangle(local_30,0,0,0x40,0x40,0xffff0000);
  D3D_CreateVertexBuffer
            (local_30,*(_String_base **)(param_1 + 0x18),*(_String_base **)(param_1 + 0xc),0,0,
             0x80ffffff);
  ...
  local_8 = 0xffffffff;
  local_1c[0] = 0;
  cVar2 = Image_AnalyzeColorUniformity((void *)(param_1 + 0x30),0x7f007f,local_1c,10,10);
  if (local_1c[0] == 0) {
    if (cVar2 != '\0') {
      ExceptionList = local_10;
      return 1;
    ...
    pcVar1 = "AlphaModulated blend test not uniform.";
    do {
      pcVar5 = pcVar1;
      pcVar1 = pcVar5 + 1;
    } while (*pcVar5 != '\0');
    String_Assign(local_3c,(_String_base *)"AlphaModulated blend test not uniform.",
                  (uint)(pcVar5 + -0x5337dc));
    local_8 = 3;
    ...
    pcVar1 = "AlphaModulated blend not supported.";
    do {
      pcVar5 = pcVar1;
      pcVar1 = pcVar5 + 1;
    } while (*pcVar5 != '\0');
    String_Assign(local_58,(_String_base *)"AlphaModulated blend not supported.",
                  (uint)(pcVar5 + -0x5337b8));
    local_8 = 4;
