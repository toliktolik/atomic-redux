/*
 * Function: D3D_InitializeRenderStates
 * Address: 004856e0
 * Category: graphics
...
undefined1 __fastcall D3D_InitializeRenderStates(int param_1)

{
  ...
  iVar4 = (**(code **)(**(int **)(param_1 + 0x18) + 0x50))(*(int **)(param_1 + 0x18),0x13,2);
  D3D_ValidateRenderTarget(iVar4,(_String_base *)"D3DRENDERSTATE_SRCBLEND, D3DBLEND_ONE");
  ...
  if (local_1c[0] == 0) {
    ...
    pcVar1 = "Additive blend test not uniform.";
    do {
      pcVar5 = pcVar1;
      pcVar1 = pcVar5 + 1;
    } while (*pcVar5 != '\0');
    String_Assign(local_3c,(_String_base *)"Additive blend test not uniform.",
                  (uint)(pcVar5 + -0x533700));
    local_8 = 3;
    ...
    pcVar1 = "Additive blend not supported.";
    do {
      pcVar5 = pcVar1;
      pcVar1 = pcVar5 + 1;
    } while (*pcVar5 != '\0');
    String_Assign(local_58,(_String_base *)"Additive blend not supported.",
                  (uint)(pcVar5 + -0x5336e0));
    local_8 = 4;
