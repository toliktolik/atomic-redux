/*
 * Function: Graphics_ProcessTextureMapping
 * Address: 004762d0
 * Category: core
...
void __cdecl
Graphics_ProcessTextureMapping(ushort *param_1,int param_2,int *param_3,int param_4,int param_5)
    ...
    if (0 < in_EAX) {
      do {
        ...
        if (0 < param_5) {
          do {
            uVar1 = *puVar4;
            *puVar6 = (ushort)(uVar1 >> 8) & 0xf800 | (ushort)(uVar1 >> 5) & 0x7e0 |
                      (ushort)(uVar1 >> 3) & 0x1f;
            iVar2 = iVar2 + -1;
            puVar4 = puVar4 + 1;
            puVar6 = puVar6 + 1;
