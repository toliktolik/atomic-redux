/*
 * Function: UI_ProcessChildBinding
 * Address: 004682d0
 * Category: ui
...
void __thiscall UI_ProcessChildBinding(void *this,uint param_1)

{
  ...
  if (uVar4 < param_1) {
    ...
    UI_ValidateChildHitTest
              (this,*(undefined4 **)((int)this + 8),param_1 - iVar5,(undefined4 *)&stack0x00000008);
    return;
  }
  if (((iVar5 != 0) &&
